...
* Substitute parts *
We are interested in substituting analogous components from suppliers you use frequently.
...
- we have yet to design the QC release testing mechanism, or add contacts to the board

*** Information requested in Quote ***

for production runs at 250, 500, 1k, 2.5k, 5k units
- costs (setup costs, unit costs, total costs)
- time from order to delivery
- amount of notice required for manufacturing run

- cost & time requirement of producing 2 test PCBAs
- clear explanation of how much of the supply chain you can manage
